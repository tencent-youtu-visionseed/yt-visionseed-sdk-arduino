...
const pb_field_t FaceShape_fields[5] = {
    PB_FIELD(  1, FLOAT   , REPEATED, POINTER , FIRST, FaceShape, x, x, 0),
    PB_FIELD(  2, FLOAT   , REPEATED, POINTER , OTHER, FaceShape, y, x, 0),
    PB_FIELD(  3, FLOAT   , REPEATED, POINTER , OTHER, FaceShape, visibility, y, 0),
...
const pb_field_t Face_fields[12] = {
    ...
    PB_FIELD(  3, MESSAGE , OPTIONAL, STATIC  , OTHER, Face, pose, rect, &Pose_fields),
    ...
    PB_FIELD( 12, UENUM   , REPEATED, POINTER , OTHER, Face, properties, age, 0),
...
const pb_field_t FaceDetectionResult_fields[4] = {
    ...
    PB_FIELD(  3, MESSAGE , REPEATED, POINTER , OTHER, FaceDetectionResult, face, height, &Face_fields),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Face, rect) < 65536 && pb_membersize(Face, pose) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Rect_Pose_FaceShape_Face_FaceDetectionResult)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Face, rect) < 256 && pb_membersize(Face, pose) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_Rect_Pose_FaceShape_Face_FaceDetectionResult)
#endif
