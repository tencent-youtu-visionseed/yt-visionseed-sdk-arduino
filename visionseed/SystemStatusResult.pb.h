...
#define SystemStatusResult_init_default          {0, 0, NULL, 0, NULL, 0}
#define SystemStatusResult_init_zero             {0, 0, NULL, 0, NULL, 0}
...
/* SystemStatusResult_size depends on runtime parameters */
