...
#define FaceShape_init_default                   {0, NULL, 0, NULL, 0, NULL, 0}
#define Face_init_default                        {Rect_init_default, false, Pose_init_default, 0, false, 0, false, 0, false, 0, false, "", false, 0, 0, NULL, false, _Face_Gender_MIN, false, 0}
#define FaceDetectionResult_init_default         {0, 0, 0, NULL}
#define Rect_init_zero                           {0, 0, 0, 0}
#define Pose_init_zero                           {0, 0, 0}
#define FaceShape_init_zero                      {0, NULL, 0, NULL, 0, NULL, 0}
#define Face_init_zero                           {Rect_init_zero, false, Pose_init_zero, 0, false, 0, false, 0, false, 0, false, "", false, 0, 0, NULL, false, _Face_Gender_MIN, false, 0}
#define FaceDetectionResult_init_zero            {0, 0, 0, NULL}
...
#define Rect_size                                44
#define Pose_size                                15
/* FaceShape_size depends on runtime parameters */
/* Face_size depends on runtime parameters */
/* FaceDetectionResult_size depends on runtime parameters */
